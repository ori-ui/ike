...
type Build = extern "Rust" fn(&mut dyn Any) -> Box<dyn ori::AnyView<Context, dyn Any, WidgetId>>;
...
pub struct ReloadState {
    view:  Box<dyn ori::AnyView<Context, dyn Any, WidgetId>>,
    state: Box<dyn Any>,
    build: Build,
}
