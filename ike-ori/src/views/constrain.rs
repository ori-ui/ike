    ...
    V: View<C, T, Element: AnyWidgetId>,
{
    ...
    fn build(&mut self, cx: &mut C, data: &mut T) -> (Self::Element, Self::State) {
        ...
        widgets::Constrain::set_max_size(&mut widget, self.max_size);
        widgets::Constrain::set_min_size_transition(&mut widget, self.min_size_transition);
        widgets::Constrain::set_max_size_transition(&mut widget, self.max_size_transition);
